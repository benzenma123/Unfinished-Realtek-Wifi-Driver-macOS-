...
static int rtw8822b_power_on(struct rtw_dev *rtwdev)
{
	return rtw_power_on(rtwdev);
}

static void rtw8822b_power_off(struct rtw_dev *rtwdev)
{
...
static int rtw8822b_read_efuse(struct rtw_dev *rtwdev, u8 *map)
{
	(void)rtwdev;
	(void)map;
	return 0;
...
static void rtw8822b_set_channel(struct rtw_dev *rtwdev, u8 channel,
				 u8 bw, u8 primary_chan_idx)
{
	rtw_set_channel_mac(rtwdev, channel, bw, primary_chan_idx);
}

static u32 rtw8822b_read_rf(struct rtw_dev *rtwdev, enum rtw_rf_path rf_path,
			    u32 addr, u32 mask)
{
	(void)rtwdev;
	(void)rf_path;
...
static bool rtw8822b_write_rf(struct rtw_dev *rtwdev, enum rtw_rf_path rf_path,
...
static void rtw8822b_efuse_grant(struct rtw_dev *rtwdev, bool enable)
{
	(void)rtwdev;
	(void)enable;
}
...
static const struct rtw_chip_ops rtw8822b_ops = {
	.power_on			= rtw8822b_power_on,
	.power_off			= rtw8822b_power_off,
	.mac_init			= rtw8822b_mac_init,
	.read_efuse			= rtw8822b_read_efuse,
	.phy_set_param			= rtw8822b_phy_set_param,
	.set_channel			= rtw8822b_set_channel,
	.read_rf			= rtw8822b_read_rf,
	.write_rf			= rtw8822b_write_rf,
	.set_tx_power_index		= rtw8822b_set_tx_power_index,
	.cfg_ldo25			= rtw8822b_cfg_ldo25,
	.efuse_grant			= rtw8822b_efuse_grant,
