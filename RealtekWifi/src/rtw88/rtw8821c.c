...
static int rtw8821c_power_on(struct rtw_dev *rtwdev)
{
	return rtw_power_on(rtwdev);
}

static void rtw8821c_power_off(struct rtw_dev *rtwdev)
{
...
static int rtw8821c_read_efuse(struct rtw_dev *rtwdev, u8 *map)
{
	(void)rtwdev;
	(void)map;
	return 0;
...
static void rtw8821c_set_channel(struct rtw_dev *rtwdev, u8 channel,
				 u8 bandwidth, u8 primary_chan_idx)
{
	(void)rtwdev;
	(void)channel;
	(void)bandwidth;
	(void)primary_chan_idx;
}

static void rtw8821c_query_phy_status(struct rtw_dev *rtwdev, u8 *phy_status,
...
static u32 rtw8821c_read_rf(struct rtw_dev *rtwdev, enum rtw_rf_path rf_path,
			    u32 addr, u32 mask)
{
	(void)rtwdev;
	(void)rf_path;
...
static bool rtw8821c_write_rf(struct rtw_dev *rtwdev, enum rtw_rf_path rf_path,
...
static void rtw8821c_efuse_grant(struct rtw_dev *rtwdev, bool enable)
{
	(void)rtwdev;
	(void)enable;
}
...
static const struct rtw_chip_ops rtw8821c_ops = {
	.power_on			= rtw8821c_power_on,
	.power_off			= rtw8821c_power_off,
	.mac_init			= rtw8821c_mac_init,
	.read_efuse			= rtw8821c_read_efuse,
	.phy_set_param			= rtw8821c_phy_set_param,
	.set_channel			= rtw8821c_set_channel,
	.query_phy_status		= rtw8821c_query_phy_status,
	.read_rf			= rtw8821c_read_rf,
	.write_rf			= rtw8821c_write_rf,
	.set_tx_power_index		= rtw8821c_set_tx_power_index,
	.cfg_ldo25			= rtw8821c_cfg_ldo25,
	.efuse_grant			= rtw8821c_efuse_grant,
